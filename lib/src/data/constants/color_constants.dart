...
const Color kPrimaryColor = Color(0xFFE30613);
const Color kSecondaryColor = Color(0xFFF3EFEF);
const Color kPrimaryLightColor = Color(0xFFE83A33);
...
const Color kGreenLight = Color.fromARGB(255, 192, 252, 194);
