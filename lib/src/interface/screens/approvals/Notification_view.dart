  ...
  Widget build(BuildContext context, WidgetRef ref) {
        ...
        return DraggableScrollableSheet(
          ...
          builder: (context, scrollController) {
            return FutureBuilder<NotificationWithPerson>(
               future: ref.watch(getSingleNotificationByIdProvider(notificationid).future),
      builder: (context, snapshot) {
        ...
        final notification = snapshot.data!.notification;
