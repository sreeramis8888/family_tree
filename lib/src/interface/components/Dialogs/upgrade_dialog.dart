      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Dummy description
            const Text(
              'To access premium features such as availability of B2B transaction capability, Personal Digital Card etc., please contact Chapter President at 9876543210 (John Doe) and ensure payment of State Subscription of Rs. 1000/- per year has been made on your behalf.',
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 24),
